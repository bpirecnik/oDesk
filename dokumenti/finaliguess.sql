...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 19, 2017 at 11:24 PM
...
(1, 'Web programming', 'Skills used for programming web applications'),
(2, 'App programming', 'Programming apps'),
(3, 'Logo design', 'Designing');
...
INSERT INTO `projects` (`id`, `category_id`, `title`, `price`, `start_date`, `end_date`, `description`, `stage`) VALUES
(1, 1, 'Project oDesk', 1200, '2017-06-19 20:48:22', '2018-01-17 22:59:59', 'Creating web page with already established layout.', 3),
(2, 3, 'Project Lex', 120, '2017-06-19 20:48:45', '2017-06-29 21:59:59', 'Testing the multiple projects on one page on profile', 3),
(21, 3, 'Projekt Andy', 120, '2017-06-19 20:48:45', '2017-06-23 22:00:00', 'Logo creation for small company.', 1),
(22, 2, 'Testing admin', 1200, '2017-06-19 20:48:45', '2017-06-19 22:00:00', 'Test for admin', 1),
(23, 3, 'Testing category', 12, '2017-05-29 22:00:00', '2017-06-22 22:00:00', 'Testing cat', 1);
...
INSERT INTO `skills` (`id`, `category_id`, `title`, `description`) VALUES
(3, 1, 'HTML', 'ASD'),
(4, 1, 'CSS', NULL),
(5, 1, 'PHP', NULL),
(6, 1, 'JavaScript', NULL);
...
(4, 1, 'Boris', 'Pire?nik', 'boriasd@as.com', '3e863f165599a720689a8ec5717ebec72f4ce8ca', '2017-06-14 16:52:54', NULL, NULL, '', 0, 0),
(5, 1, 'Test 2', 'Test 2', 'test@odesk.com', '6e590cf5239b0049b240c813295deacde1051f6d', '2017-06-14 16:54:34', NULL, NULL, '', 0, 0),
(6, 2, 'Matic', 'Jesenicnik', 'matic@odesk.com', 'cf0129fc11da0fdedfcbec76db68c82762c0dd84', '2017-06-16 08:01:18', NULL, NULL, '', 0, 0);
...
--
ALTER TABLE `skills`
  ADD CONSTRAINT `skills_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`);
...
ALTER TABLE `skills_users`
  ...
  ADD CONSTRAINT `skills_users_ibfk_3` FOREIGN KEY (`rank_id`) REFERENCES `ranks` (`id`);
